...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, handleViewRef, Modal, ImageBackground } from 'react-native';
import { Container, Header, Left, Body, Title, Icon, Button, Content, Form, Item, Input, Label } from 'native-base';
