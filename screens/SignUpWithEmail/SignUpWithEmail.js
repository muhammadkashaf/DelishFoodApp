...
import { Header, Left, Body, Title, Icon, Button, Item, Spinner } from 'native-base';
    ...
    signUp = () => {
        ...
        if (email && password && phone && fname.length >= 5 && lname.length >= 5 && phone.length > 7) {
            if (reg.test(email) === false) {
                ...
                //  console nahi chal raha he debug on kya he??
                ...
                // if (
                //     axios.post("https://mobileappstore.co.uk/mudasir/delish/api/user.php", obj)
                ...
                // }
                //wait 1 min ma aya ok
                // fetch("https://mobileappstore.co.uk/mudasir/delish/api/user.php", {
                //     method: 'POST',
                //     // dataType: "json",
                //     headers: {
